...
#这个py文件需要把classes里面改为自己的json文件的label名
if __name__ == '__main__':
    jpgs_path   = "jpg"
    pngs_path   = "datasets/png"
    ...
    classes =["_background_","chromsome1","chromsome2","chromsome3","chromsome4","chromsome5","chromsome6","chromsome7","chromsome8","chromsome9",
"chromsome10","chromsome11","chromsome12"]


    
    count = os.listdir("chromsome")
    for i in range(0, len(count)):
        path = os.path.join("chromsome", count[i])
